...
TEMPLATES: dict[str, dict] = {
    ...
    "ethereal_boots" : {
        "spawn_as":         Item, 
        "name": "a pair of &methereal boots&N",
    ...
    "star" : {
        "spawn_as":         Item,
        "name":      "&ya floating star&N",
        "key_words": ("star"),
        "room_description": "A &Wbright&N, floating object hovers here.",
        "description": "An interesting light source. It appears to be a star, yet its energy is stable",
        "wear_on":   "light",
        "hours":    -1,
        "weight":    5,
        "cost":      100,
