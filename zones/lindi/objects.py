...
TEMPLATES: dict[str, dict] = {
    ...
    "water bottle" : {
      ...
      "math sword" : {
         ...
         'room_description': "the math sword gleams in its golden furnishing",
         'description': """this longsword is gorgeously golden and gem encrusted.""",
         "weight":           2,
         "dice":             "8d8",
         "hitroll":          8,
         "damroll":          8,
     ...
     "dagger of detriment" : {
         "spawn_as":         Weapon,
         'name': "dagger of detriment",
         'key_words': ('dagger', 'detriment'),
         'room_description': "the dagger of detriment lays on the floor",
         'description': "this is a short emerald blade, with an ominous glow",
         "weight":           2,
         "dice":             "8d8",
         "hitroll":          10,
         "damroll":          10,
